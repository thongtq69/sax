            ...
            <div className="animate-fade-in-left">
              ...
              <div className="space-y-2 sm:space-y-2.5">
                {[
                  ...
                  <div key={i} className="flex gap-3 sm:gap-4 p-2.5 sm:p-3 bg-white border border-transparent hover:border-primary/30 transition-all duration-500 hover:shadow-lg">
