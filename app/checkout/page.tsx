...
import { ShieldCheck, Lock, Package, Truck, ArrowLeft } from 'lucide-react'
            ...
            <div className="lg:col-span-7">
              <div className="bg-white rounded-xl border p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl font-semibold">Fill this address if it differs from your PayPal address</h2>
                </div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-xl border p-6 space-y-4">
                ...
                <PayPalButton
                  ...
                  onError={(error) => { setPaymentError('Payment failed'); console.error(error) }}
                />
                {paymentError && <p className="text-center text-red-500 text-sm">{paymentError}</p>}
