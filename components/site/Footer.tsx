    ...
    <footer className="bg-[#2f3f4f] text-white">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 md:py-6">
        ...
        <div className="sm:hidden">
          ...
          <div className="flex items-center justify-between gap-2 pb-2.5 mb-2.5 border-b border-white/10 animate-fade-in-up">
            ...
            <div className="flex gap-1.5">
              <Button size="sm" className="bg-[#D4AF37] hover:bg-[#c4a030] text-[#2f3f4f] font-semibold text-[9px] px-2 h-6 hover:scale-105 transition-transform" asChild>
                <Link href="tel:+17025551234">
                  <Phone className="mr-0.5 h-2.5 w-2.5" />
                  Call
                </Link>
              </Button>
              <Button size="sm" variant="outline" className="border-white/30 text-white hover:bg-white/10 text-[9px] px-2 h-6 hover:scale-105 transition-transform" asChild>
          ...
          <div className="flex items-start gap-3 pb-2.5 mb-2.5 border-b border-white/10 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <div className="border border-[#D4AF37]/50 rounded p-1.5 bg-[#D4AF37]/5 flex-shrink-0 hover:border-[#D4AF37] transition-colors">
              <Image
                src="/logo.png"
          ...
          <div className="grid grid-cols-4 gap-2 text-[9px] animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            {/* Hours */}
            <div>
        ...
        <div className="hidden sm:block">
          {/* CTA Row - Desktop */}
          <div className="flex items-center justify-between gap-3 pb-6 mb-6 border-b border-white/10 animate-fade-in-up">
            <div>
          ...
          <div className="grid grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="border border-[#D4AF37]/50 rounded-lg p-2.5 inline-block mb-3 bg-[#D4AF37]/5 hover:border-[#D4AF37] hover:bg-[#D4AF37]/10 transition-all duration-300 group">
                <Image
                  src="/logo.png"
                  alt="James Sax Corner"
                  width={120}
              ...
              <div className="space-y-1.5 text-sm text-white/80">
                ...
                <Link href="mailto:info@jamessaxcorner.com" className="flex items-center gap-2 hover:text-white transition-all duration-300 group">
                  <Mail className="h-4 w-4 text-[#D4AF37] flex-shrink-0 transition-transform group-hover:scale-110" />
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              <ul className="space-y-1.5 text-sm text-white/80">
                {[
                  { href: '/shop', text: 'All Instruments' },
                  { href: '/cart', text: 'Cart' },
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="flex items-center gap-1.5 group cursor-default">
                <span className="text-[#D4AF37] text-base transition-transform group-hover:scale-125 group-hover:rotate-12">★</span>
