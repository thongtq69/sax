    ...
    <footer className="bg-[#2f3f4f] text-white">
      <div className="container mx-auto px-3 lg:px-4 py-2 lg:py-4">
        ...
        <div className="hidden lg:block">
          ...
          <div className="flex items-center justify-center gap-3 pb-6 mb-6 border-b border-white/10">
            <div className="flex flex-col items-center gap-3 text-center">
              <div>
                <h3 className="text-sm md:text-lg font-bold text-white flex items-center justify-center gap-2">
              ...
              <Button size="sm" className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-semibold text-xs md:text-sm px-4 h-8 md:h-9 flex-shrink-0" asChild>
                <Link href="/inquiry">
