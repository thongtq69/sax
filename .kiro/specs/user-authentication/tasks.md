...
- [ ] 1. Setup NextAuth.js và Database Schema
  - [ ] 1.1 Install NextAuth.js và dependencies
    - Install next-auth, @auth/prisma-adapter, nodemailer
    - _Requirements: 1.1, 3.1, 4.1, 5.1_
  - [ ] 1.2 Update Prisma schema với User, Account, Session, VerificationToken models
...
- [ ] 3. Implement Registration API
  - [ ] 3.1 Create registration API route (/api/auth/register)
  ...
  - [ ] 3.2 Implement email verification token generation
    ...
    - _Requirements: 2.1_
  - [ ] 3.3 Setup email service for verification emails
...
- [ ] 4. Implement Email Verification
  - [ ] 4.1 Create verify-email API route (/api/auth/verify-email)
    - Validate token exists and not expired
    - Mark user emailVerified with current timestamp
    - Delete used token
    - _Requirements: 2.2, 2.3_
  - [ ] 4.2 Create resend verification API route
    - Invalidate existing tokens for user
    - Generate new token
    - Send new verification email
    - _Requirements: 2.4_
  - [ ] 4.3 Create email verification page (/auth/verify-email)
...
- [ ] 5. Implement Password Reset
  - [ ] 5.1 Create forgot-password API route (/api/auth/forgot-password)
    - Validate email exists
    - Generate reset token with 1-hour expiry
    - Send reset email
    - _Requirements: 7.1_
  - [ ] 5.2 Create reset-password API route (/api/auth/reset-password)
    - Validate token exists and not expired
    - Update user password with new hash
    - Delete used token
    - _Requirements: 7.2, 7.3_
  - [ ] 5.3 Create forgot password page (/auth/forgot-password)
    - Email input form
    - Success message after submission
    - _Requirements: 7.1_
  - [ ] 5.4 Create reset password page (/auth/reset-password)
...
- [ ] 12. Add Environment Variables Documentation
  - [ ] 12.1 Update .env.example with required auth variables
